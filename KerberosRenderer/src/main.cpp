...
private:
	...
	{
		textureImageView = CreateImageView(device, textureImage, vk::Format::eR8G8B8A8Srgb, vk::ImageAspectFlagBits::eColor);
	}
	...
	void UpdateUniformBuffers(const uint32_t currentImage) const 
	{
