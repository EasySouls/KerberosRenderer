...
struct CameraComponent
{
    ...
    explicit CameraComponent(const SceneCamera& camera) : Camera(camera) {}
...
struct StaticMeshComponent
{
    ...
    StaticMeshComponent(const Ref<Mesh>& mesh, const Ref<Material>& material) : StaticMesh(mesh), MeshMaterial(material)
    {
    }
...
struct ModelComponent
{
    ...
    explicit ModelComponent(const AssetHandle modelAsset) : ModelAsset(modelAsset) {}
...
struct PrefabInstanceComponent
{
    ...
    explicit PrefabInstanceComponent(const AssetHandle prefab) : PrefabAsset(prefab) {}
};
...
struct DirectionalLightComponent
{
    ...
    explicit DirectionalLightComponent(const DirectionalLight& light) : Light(light) {}
};
...
struct PointLightComponent
{
    ...
    explicit PointLightComponent(const PointLight& light) : Light(light) {}
};
...
struct SpotLightComponent
{
    ...
    explicit SpotLightComponent(const SpotLight& light) : Light(light) {}
};
...
struct TextComponent
{
    ...
    explicit TextComponent(const Ref<Kerberos::Font>& font, std::string text) : Font(font), Text(std::move(text)) {}
};
